<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="postinggaz2.aspx.cs" Inherits="postinggaz2" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
          Posting and Transfer - Gazetted
           <div class="pull-right"><a class="archHyper" href="postinggaz.aspx"> Archive</a></div>
        </div>
