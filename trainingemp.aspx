<%@ Page Title="PSTCL :: Training" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="trainingemp.aspx.cs" Inherits="trainingemp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           Training - Employees
           <div class="pull-right"><a class="archHyper" href="trainingemp_arch.aspx"> Archive</a></div>
        </div>
