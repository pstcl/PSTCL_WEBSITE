<%@ Page Title="Posting & Transfer: Non-Gazetted" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="postingnongaz2.aspx.cs" Inherits="postingnongaz2" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           ...
           <div class="pull-right"><a class="archHyper" href="postingnongaz.aspx"> Archive</a></div>
        </div>
