<%@ Page Language="C#" AutoEventWireup="true" CodeFile="defaultnew.aspx.cs" Inherits="defaultnew" %>
...
<head runat="server">
      <title> </title>
    <link id="Link1" rel="shortcut icon" type="image/png" href="images/favicon.png" runat="server" />
     <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width">
    <meta name="description" content="www.pstcl.org Punjab State Transmission Corporation Limited is looking after transmission in the state of Punjab." />
    <meta name="keywords" content="PSTCL, Electricity, Punjab, State, Transmission, Corporation, Limited, Punjab State Transmission Corporation Limited" />
    <meta name="expires" content="never" />
    <meta name="allow-search" content="yes" />

    <link rel="stylesheet" href="themeX.2/css/bootstrap.min.css?v=11.0" />
    <link rel="stylesheet" href="themeX.2/css/bootstrap-responsive.min.css?v=19.1" />
    <link rel="stylesheet" href="themeX.2/css/font-awesome.min.css?v=2.1" />
    <link rel="stylesheet" href="themeX.2/css/main.css?v=9.2" />
    <link rel="stylesheet" href="themeX.2/css/sl-slide.css" />
    <script src="themeX.2/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
...
<body>
    ...
    <% Response.WriteFile("~/_header.html");%>
    <!--Slider-->
        ...
        <div class="sl-slider">
            ...
            <div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="themeX.2/images/sample/slider/img1.png" alt="" />
                        <h2>Creative </h2>
            ...
            <div class="sl-slide item2" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
                <div class="sl-slide-inner">
                    <div class="container">
                        <img class="pull-right" src="themeX.2/images/sample/slider/img2.png" alt="" />
                        <h2>Planning &amp; </h2>
            ...
            <div class="sl-slide item3" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
                <div class="sl-slide-inner">
                   <div class="container">
                    <img class="pull-right" src="themeX.2/images/sample/slider/img3.png" alt="" />
...
<section id="recent-works">
    <div class="container">
        ...
        <ul class="gallery col-4">
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="themeX.2/images/portfolio/thumb/item1.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-1" class="modal hide fade">
                    ...
                    <div class="modal-body">
                        <img src="themeX.2/images/portfolio/full/item1.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 1--> 
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="themeX.2/images/portfolio/thumb/item2.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                        <a data-toggle="modal" href="#modal-1"><i class="icon-eye-open"></i></a><a href="#"><i class="icon-link"></i></a>                                
                ...
                <div id="modal-1" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="themeX.2/images/portfolio/full/item2.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 2-->
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="themeX.2/images/portfolio/thumb/item3.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-3" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="themeX.2/images/portfolio/full/item3.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 3--> 
            ...
            <li>
                <div class="preview">
                    <img alt=" " src="themeX.2/images/portfolio/thumb/item4.jpg">
                    <div class="overlay">
                    </div>
                    <div class="links">
                ...
                <div id="modal-4" class="modal hide fade">
                    <a class="close-modal" href="javascript:;" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i></a>
                    <div class="modal-body">
                        <img src="themeX.2/images/portfolio/full/item4.jpg" alt=" " width="100%" style="max-height:400px">
                    </div>
                </div>                 
            </li>
            <!--/Item 4-->               
                ...
                <div id="myCarousel" class="carousel slide clients">
                  ...
                  <div class="carousel-inner">
                    <div class="active item">
                        <div class="row-fluid">
                            <ul class="thumbnails">
                                <li class="span3"><a href="#"><img src="themeX.2/images/sample/clients/client1.png"></a></li>
                                <li class="span3"><a href="#"><img src="themeX.2/images/sample/clients/client2.png"></a></li>
                                <li class="span3"><a href="#"><img src="themeX.2/images/sample/clients/client3.png"></a></li>
                                <li class="span3"><a href="#"><img src="themeX.2/images/sample/clients/client4.png"></a></li>
                            </ul>
                        </div>
                    </div>
...
<script src="themeX.2/js/vendor/jquery-1.9.1.min.js"></script>
<script src="themeX.2/js/vendor/bootstrap.min.js"></script>
<script src="themeX.2/js/main.js"></script>
<!-- Required javascript files for Slider -->
<script src="themeX.2/js/jquery.ba-cond.min.js"></script>
<script src="themeX.2/js/jquery.slitslider.js"></script>
<!-- /Required javascript files for Slider -->
