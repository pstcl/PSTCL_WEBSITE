<%@ Page Title="PSTCL :: Recruitment" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="recruitindex.aspx.cs" Inherits="recruitindex" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           Recruitment
           <div class="pull-right"><a class="archHyper" href="recruitindex_arch.aspx"> Archive</a></div>
        </div>
