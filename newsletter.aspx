<%@ Page Title="PSTCL :: Newsletter" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="newsletter.aspx.cs" Inherits="newsletter" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           Newsletter
           <div class="pull-right"><a class="archHyper" href="newsletter_arch.aspx"> Archive</a></div>
        </div>
