<%@ Page Title="PSTCL Office Orders/ Circulars" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="storedisposal.aspx.cs" Inherits="storedisposal" %>
...
<table  width="100%" style="height:520px; background-color: #FCFCFC; ">
    ...
    <tr  valign="top" >
        <td colspan="" class="mBlockHeader">
           Office Orders/ Circulars : Store and Disposal Section
