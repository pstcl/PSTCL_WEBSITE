<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="tenderAward.aspx.cs" Inherits="tenderAward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <div style="height: 520px;  background-color: #FCFCFC;">
        ...
        <div style="margin-left: auto; margin-right: auto; margin-top: 20px;">
            <table class="display" id="PostingTable" style="font-size: 10px; width: 100%">
                <thead>
            ...
            <script  type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "tenderAward.aspx/getTableDataTenderAward",
                        data: "{}",
                        async: false,
