<%@ Page Title="PSTCL :: List of Tenders" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="nit_live.aspx.cs" Inherits="nit_live" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           Notice Inviting Tenders: Live
           <div class="pull-right"><a class="archHyper" href="nit_arch.aspx"> Archive</a></div>
        </div>
