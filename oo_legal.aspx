<%@ Page Title="Office Orders/ Circulars" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="oo_legal.aspx.cs" Inherits="oo_legal" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           Office Orders/ Circulars :  Legal Section
           <div class="pull-right"><a class="archHyper" href="oo_legal_arch.aspx"> Archive</a></div>
        </div>
