<%@ Page Title="PSTCL :: DE-Notices" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="deptexamnotif.aspx.cs" Inherits="deptexamnotif" %>
...
<div class="mat-box" style=" margin-left: 6px; margin-right: 2px; margin-top: 7px;">
        <div class="mat-header mat-text" style="">
           ...
           <div class="pull-right"><a class="archHyper" href="deptexamnotif_arch.aspx"> Archive</a></div>
        </div>
