<%@ Page Title="PSTCL :: Organisation" Language="C#" MasterPageFile="~/MasterPstcl.master" AutoEventWireup="true" CodeFile="orgchartpm.aspx.cs" Inherits="orgchartpm" %>
            ...
            <div style="margin-left: auto; margin-right: auto; margin-top: 10px;">
             <div id='chart-container'>
              ...
              <ul id='chart-source'>
                   <li>CE/P&M
                       <ul>
                            <li>SE/P&M &nbsp; (Patiala)</li>
                            <li>SE/P&M (Bathinda)</li>
                            <li>SE/P&M (Ludhiana)</li>
                            <li>SE/P&M (Jalandhar)</li>
                            <li>SE/P&M (Amritsar)</li>
                       </ul>
                   </li>
              </ul>
             </div>
